...
<div class="container ">
	<div class="row">
            ...
            <div id="mapa"  text-align="center">
              <svg id="map" x="0px" y="0px" align="center" width="450px" height="460px">
                <g>
                  ...
                  <a href="#" id="state_ce" class="state" cod-state="2300108" data-state="Ceará" xlink:href="">
                  <title>Ceará</title>
                  ...
                  <a href="#" id="state_pi" class="state" cod-state="2200108" data-state="Piauí" xlink:href="">
                  <title>Piauí</title>
                  ...
                  <a href="#" id="state_ma" class="state" cod-state="2100108" data-state="Maranhão" xlink:href="">
                  ...
                  <a href="#" id="state_ap" class="state" cod-state="1600108" data-state="Amapá" xlink:href="">
                  <title>Amapá</title>
                  ...
                  <a href="#" id="state_pa" class="state" cod-state="1500108" data-state="Pará" xlink:href="">
                  <title>Pará</title>
                  ...
                  <a href="#" id="state_ro" class="state" cod-state="1100108" data-state="Rondônia" xlink:href="">
                  ...
                  <a href="#" id="state_go" class="state" cod-state="5200108" data-state="Goiás" xlink:href="">
                  <title>Goiás</title>
                  ...
                  <a href="#" id="state_pr" class="state" cod-state="4100108" data-state="Paraná" xlink:href="">
                  <title>Paraná</title>
                  ...
                  <a href="#" id="state_sp" class="state" cod-state="3500108" data-state="São Paulo" xlink:href="">
                  ...
                  <a href="#" id="state_es" class="state" cod-state="3200108" data-state="Espírito Santo" xlink:href="">
                  ...
                  <a href="#" id="state_pb" class="state" cod-state="2500108" data-state="Paraíba" xlink:href="">
                  <title>Paraíba</title>
        ...
        <div id="seleciona-data" class="col-xl-4 custom-col" align="center">
        	<input type="text" class="form-control custom-form shadow p-3 mb-5 bg-white rounded" name="datepicker" id="datepicker" placeholder="Selecione o Mês" size="3"style="border-color: #0094d9;"/>
