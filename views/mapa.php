      ...
      <div id="seleciona-data" class="col-xl-4 custom-col" align="center">
        <div class="card text-dark shadow p-3 mb-5 bg-white rounded" style="max-width: 25rem;margin-top:20px;border-color:#0094d9;">
          ...
          <div class="cardRegiao" align="center">
            <select id="selEstados" class="btn btn-primary btn-lg cardItemRegiao" placeholder="Selecione o Estado" style="border-color: #0094d9;">
              <option>Selecione o Estado</option>
            </select>
          </div>

          <div id="divMunicipio" class="cardRegiao">
            <select class="btn btn-primary btn-lg cardItemRegiao" id="selMunicipio">
