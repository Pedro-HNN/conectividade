	...
	$(document).ready(function () {
		...
		$('#map .state').click(function () {
			...
			if (anoMes == '') {
				...
				valorAuxilio = dadoProvisorio[0].valor;
				beneficiariosAuxilio = dadoProvisorio[0].quantidadeBeneficiados;
				valorBolsa = dadoProvisorio[0].valor;
				beneficiariosBolsa = dadoProvisorio[0].quantidadeBeneficiados;
